...
from honeybee_radiance.cli.multiphasemtx import three_phase_calc
from honeybee_radiance.cli.multiphasemtx import three_phase_rmtxop
...
def test_three_phase_calc():
    ...
    cmd_args = [
        sky_vector,view_matrix,t_matrix,daylight_matrix,output_matrix]
