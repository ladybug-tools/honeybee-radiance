...
class Mirror(Material):
    ...
    as None or Void, then the mirror surface will be invisible. This is only appropriate
    if the surface hides other (more detailed) geometry with the same overall reflectance. 
    ...
    def alternate_material(self):
        ...
        If this alternate material is given as None, then the mirror surface
        will be invisible.
        """
