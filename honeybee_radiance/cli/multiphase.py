...
def dmtx_group_command(
    ...
    try:
        ...
        assert len(apertures) != 0, \
            'Found no valid dynamic apertures.'
        
        # Calculate view factor.
        mtx_file, ap_dict = _aperture_view_factor(model_folder.folder, apertures,
            size=size, ambient_division=ambient_division, receiver=rflux_sky, octree=octree,
        ...
        # Calulate RMSE between all combinations of averaged aperture view factors.
        ...
        for idx, group in enumerate(ap_groups):
            ...
            for ap in group:
                ...
                ap_dict[ap]['aperture_group'] = group_name
                ap_dict[ap]['dmtx_port'] = group_file
            if write_rad_files == True:
