...
class DoorRadianceProperties(object):
    ...
    def __init__(self, host, modifier=None, modifier_blk=None):
        ...
        Args:
            ...
            modifier_blk: A Honeybee Radiance Modifier object to be used for this
                ...
                a completely black material if the Door's modifier is opaque and
                will be equal to the modifier if the Door's modifier is non-opaque.
        """
        self._host = host
    ...
    def is_modifier_set_on_object(self):
        """Boolean noting if modifier is assigned on the level of this Door.
    ...
    def reset_to_default(self):
        """Reset a Modifier assigned at the level of this Door to the default.

        This means that the Door's modifier will be assigned by a ModifierSet instead.
        """
        self._modifier = None
    ...
    def duplicate(self, new_host=None):
        ...
        return DoorRadianceProperties(_host, self._modifier, self._modifier_blk)
