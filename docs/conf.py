...
latex_documents = [
    (master_doc, 'honeybee radiance.tex', 'honeybee radiance Documentation',
...
man_pages = [
    (master_doc, 'honeybee radiance', 'honeybee radiance Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'honeybee radiance', 'honeybee radiance Documentation',
     author, 'honeybee radiance', 'One line description of project.',
     'Miscellaneous'),
]
